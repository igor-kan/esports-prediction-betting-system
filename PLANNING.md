...
## Goal
Create and maintain a reliable execution roadmap for **Esports Prediction and Betting System**.

## Context
Production-oriented repository for Esports outcome prediction and betting execution using publicly available data.
