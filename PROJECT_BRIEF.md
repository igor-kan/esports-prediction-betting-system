...
- Summary: Production-oriented repository for Esports outcome prediction and betting execution using publicly available data.
...
## Codebase Signals
- Files scanned (capped): 31
- Common extensions: .py, .md, .sh, .example, .ini, .txt
