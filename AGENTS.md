...
Repository-specific working guide for coding agents on **Esports Prediction and Betting System**.

## Snapshot
- Repository: `esports-prediction-betting-system`
- Path: `/home/igorkan/repos/esports-prediction-betting-system`
- Purpose: Production-oriented repository for Esports outcome prediction and betting execution using publicly available data.
