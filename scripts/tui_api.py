#!/usr/bin/env python3
"""Curses TUI client for Esports Prediction and Betting API."""
...
def draw(stdscr: curses.window, base_url: str, output: str) -> None:
    ...
    title = f"Esports API TUI  |  base: {base_url}"
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="TUI for Esports API")
